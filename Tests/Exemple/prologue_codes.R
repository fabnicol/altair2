...
controle<-c("REGION OCCITANIE, REGION OCCITANIE - ELUS","20005379100048 - 20005379100014","REGION OCCITANIE - REGION OCCITANIE CESER - REGION OCCITANIE CR - Site de TOULOUSE","Multi budgets")  
