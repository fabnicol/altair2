...
controle<-c("CH D ARDECHE MERIDIONALE, CENTRE HOSPITALIER D ARDECHE MERIDIONALE","20001138500016","CH D ARDECHE MERIDIONALE - CENTRE HOSPITALIER D ARDECHE MERIDIONALE","MULTIBUDGET, Centre hospitalier")  
