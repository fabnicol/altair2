...
controle<-c("SDIS, SERVICE DEPARTEMENTAL INCENDIE SECOURS, 28310001400028","28310001400028 - AUTRES","SERVICE DEPART.INC.SECOURS 31. - SERVICE DEPARTEMENTAL INCENDIE SECOURS","61BUDGET ANNEXE FORMATION, BUDGET PRINCIPAL")  
