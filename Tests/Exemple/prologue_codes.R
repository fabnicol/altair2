...
controle<-c("REGION MIDI-PYRENEES, REGION OCCITANIE, REGION LRMP","23310001500012 - 20005379100014","REGION MIDI-PYRENEES - Site de TOULOUSE","BUDGET PRINCIPAL, BUDGET ANNEXE, Multi budgets")  
