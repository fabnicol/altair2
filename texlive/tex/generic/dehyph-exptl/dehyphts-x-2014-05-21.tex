% dehyphts-x-2014-05-21.tex
%
% Copyright 2009, 2011, 2012, 2013, 2014 Werner Lemberg <wl@gnu.org>
...
%
  ...
  \else
    \catcode"C3=\active
    % The word list used for generating German hyphenation patterns is
    % encoded in Latin1.
    \def^^c3#1{%
...
%
      ...
      \errmessage{Hyphenation pattern file `dehyphts-x-2014-05-21.tex' corrupted!}%
...
%
  ...
  \fi
%
  \input dehyphts-x-2014-05-21.pat
\else
