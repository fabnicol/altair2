...
/// - une version du [logiciel Clonezilla](http://www.clonezilla.org), au moins 2.5.4, entreposée à fins d'archivage sur le dépôt gitlabjf [à cette adresse](https://gitlabjf.ccomptes.fr/fnicol/clonezilla/blob/master/clonezilla.git) 
/// \section Procédure de création de l'image de la plateforme
...
///
/// \section Procédure de clonage de la plateforme
