...
const QMetaObject processPage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_processPage.data,
...
void *processPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "common"))
        return static_cast< common*>(const_cast< processPage*>(this));
...
const QMetaObject standardPage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_standardPage.data,
...
void *standardPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "common"))
        return static_cast< common*>(const_cast< standardPage*>(this));
    return QDialog::qt_metacast(_clname);
}
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        codePage *_t = static_cast<codePage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject codePage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_codePage.data,
      qt_meta_data_codePage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *codePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_codePage.stringdata0))
        return static_cast<void*>(const_cast< codePage*>(this));
    if (!strcmp(_clname, "common"))
        return static_cast< common*>(const_cast< codePage*>(this));
    return QDialog::qt_metacast(_clname);
}
...
void options::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->enchainerRapports((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
...
void *options::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "common"))
        return static_cast< common*>(const_cast< options*>(this));
    return QDialog::qt_metacast(_clname);
}
