...
const QMetaObject processPage::staticMetaObject = {
    { &common::staticMetaObject, qt_meta_stringdata_processPage.data,
      qt_meta_data_processPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *processPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_processPage.stringdata0))
        return static_cast<void*>(const_cast< processPage*>(this));
...
struct qt_meta_stringdata_dirPage_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_dirPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_dirPage_t qt_meta_stringdata_dirPage = {
    {
QT_MOC_LITERAL(0, 0, 7) // "dirPage"
...
static const uint qt_meta_data_dirPage[] = {
...
void dirPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject dirPage::staticMetaObject = {
    { &common::staticMetaObject, qt_meta_stringdata_dirPage.data,
      qt_meta_data_dirPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *dirPage::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *dirPage::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_dirPage.stringdata0))
        return static_cast<void*>(const_cast< dirPage*>(this));
    return common::qt_metacast(_clname);
}

int dirPage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = common::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
QT_MOC_LITERAL(3, 22, 10), // "changePage"
QT_MOC_LITERAL(4, 33, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(5, 50, 7), // "current"
QT_MOC_LITERAL(6, 58, 8) // "previous"

    },
    "options\0defaultClick\0\0changePage\0"
