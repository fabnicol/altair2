...
void FDialogConnections::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FDialogConnections::setProgressBar)) {
                *result = 0;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FDialogConnections::hideProgressBar)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (FDialogConnections::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FDialogConnections::showProgressBar)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject FDialogConnections::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FDialogConnections.data,
      qt_meta_data_FDialogConnections,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FDialogConnections::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FDialogConnections.stringdata0))
        return static_cast<void*>(const_cast< FDialogConnections*>(this));
...
const QMetaObject FDialog::staticMetaObject = {
    { &FDialogConnections::staticMetaObject, qt_meta_stringdata_FDialog.data,
      qt_meta_data_FDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FDialog.stringdata0))
        return static_cast<void*>(const_cast< FDialog*>(this));
