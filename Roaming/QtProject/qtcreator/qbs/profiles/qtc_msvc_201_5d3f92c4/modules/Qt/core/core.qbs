...
Module {
    ...
    property stringList staticLibsRelease: ["kernel32.lib", "user32.lib", "shell32.lib", "uuid.lib", "ole32.lib", "advapi32.lib", "ws2_32.lib", "mpr.lib", "C:/Build/qt5/qtbase/lib/qtpcre.lib"]
    ...
    property string libNameForLinkerDebug: "Qt5Cored.lib"
    property string libNameForLinkerRelease: "Qt5Core.lib"
    ...
    property string libFilePathRelease: "C:/Build/qt5/qtbase/lib/Qt5Core.lib"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["C:/Build/qt5/qtbase/lib"]
    ...
    cpp.includePaths: {
        var paths = ["C:/Build/qt5/qtbase/include", "C:/Build/qt5/qtbase/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib", "C:/Build/qt5/qtbase/lib/qtmaind.lib"] : ["Shell32.lib", "C:/Build/qt5/qtbase/lib/qtmain.lib"]);
        }
