...
Module {
    ...
    property stringList staticLibsRelease: ["kernel32.lib", "user32.lib", "shell32.lib", "uuid.lib", "ole32.lib", "advapi32.lib", "ws2_32.lib", "mpr.lib"]
    ...
    property string libFilePathRelease: "E:/Build/Qt5.4.1.static/qtbase/lib/Qt5Core.lib"
    ...
    cpp.includePaths: {
        var paths = ["E:/Build/Qt5.4.1.static/qtbase/include", "E:/Build/Qt5.4.1.static/qtbase/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib", "E:/Build/Qt5.4.1.static/qtbase/lib/qtmaind.lib"] : ["Shell32.lib", "E:/Build/Qt5.4.1.static/qtbase/lib/qtmain.lib"]);
        }
