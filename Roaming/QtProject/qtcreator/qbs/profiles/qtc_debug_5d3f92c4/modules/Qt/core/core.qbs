...
Module {
    ...
    property string libFilePathDebug: "C:/Qt/Qt5.5.0/5.5/msvc2013_64/lib/Qt5Cored.lib"
    property string libFilePathRelease: "C:/Qt/Qt5.5.0/5.5/msvc2013_64/lib/Qt5Core.lib"
    ...
    cpp.includePaths: {
        var paths = ["C:/Qt/Qt5.5.0/5.5/msvc2013_64/include", "C:/Qt/Qt5.5.0/5.5/msvc2013_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib", "C:/Qt/Qt5.5.0/5.5/msvc2013_64/lib/qtmaind.lib"] : ["Shell32.lib", "C:/Qt/Qt5.5.0/5.5/msvc2013_64/lib/qtmain.lib"]);
        }
