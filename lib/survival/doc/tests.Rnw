...
\title{Populations, Cox models, and ``type III'' tests}
...
Consider the data shown in figure \ref{fig1} below, which shows a particular
...
Senn \ref{Senn00} points out the strong parallels between tests for main effects
