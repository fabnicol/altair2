...
find.pandoc <- function() {
  ...
  if (setOSWindows) {
     Sys.setenv(PATH = Sys.getenv("PATH")  %+%  ";C:\\Users\\Public\\Dev\\altair\\texlive2\\texmfs\\install\\miktex\\bin\\x64"  %+%  ";C:\\Users\\Public\\Altair\\texlive2\\texmfs\\install\\miktex\\bin\\x64" %+% "C:\\rtools43\\home\\Altair\\texlive2\\texmfs\\install\\miktex\\bin\\x64" )
     repert <-  c("C:\\Users\\Public\\Dev\\altair\\RStudio\\bin\\pandoc", "C:\\Users\\Public\\Altair\\RStudio\\bin\\pandoc", "C:\\rtools43\\home\\Altair\\RStudio\\bin\\pandoc")
  } else {
