...
"script_noria" %a% FALSE
"script_NBI" %a% TRUE    
"script_PFI" %a% FALSE    
"script_IATIFTS" %a% FALSE    
"script_PFR" %a% FALSE    
"script_PSR" %a% FALSE    
"script_IPF" %a% FALSE    
...
"controle" %a% c("CONSEIL DEPARTEMENTAL DES HAUTES-PYRENEES, ASE65, 22650001500012, MAISON DEPT DES PERSONNES HANDICAPEES","22650001500012 - 22650001500350 - 22650001500111 - ELU - 13000029200016","ELU - CONSEIL DEPARTEMENTAL - TRANSPORT - ASSISTANTE FAMILIALE - CONSEIL DEPARTEMENTAL DES HAUTES-PYRENEES - M.D.P.H","BUDGET PRINCIPAL, BUDGET TRANSPORT, Multi budgets, Budget MDPH")  
