...
#### INSEE/DGCL   ####
#'  
#'  |  net (euros)     | 2011    | 2012   |  2013  |  2014  | 2016   | 2017   | 2018  |      
#'  |------------------|--------:|-------:|-------:|-------:|-------:|-------:|------:|     
#'  |    Ensemble      |  21 876 | 22 176 | 22 224 | 22 524 | 22 824 | 23 328 | 23 556| 
#'  |   Titulaires     |  22 632 | 22 920 | 22 920 | 23 424 | 23 820 | 24 312 | 24 480|
...
#'     
#' | Décile \ euros   | 2011 FPT | 2013 FPT| 2014 FPT | 2016 FPT|2017 FPT |2018 FPT|   
#' |------------------|----------|---------|----------|---------|---------|--------|   
#' |    D1            | 15 288   | 15 600  | 15 768   |  15 912 | 16 272  | 16 435 |   
#' |    D2            | 16 512   | 16 860  | 17 124   |  17 340 | 17 688  | 17 836 |   
#' |    D3            | 17 508   | 17 844  | 18 156   |  18 432 | 18 828  | 18 985 |   
#' |    D4            | 18 480   | 18 816  | 19 164   |  19 476 | 19 908  | 20 104 |   
#' |    D5 (médiane)  | 19 632   | 19 908  | 20 256   |  20 616 | 21 096  | 21 320 |   
#' |    D6            | 21 012   | 21 300  | 21 648   |  22 020 | 22 548  | 22 781 |  
#' |    D7            | 22 860   | 23 160  | 23 496   |  23 868 | 24 444  | 24 666 |   
#' |    D8            | 25 596   | 25 956  | 26 292   |  26 700 | 27 336  | 27 571 |  
#' |    D9            | 30 876   | 31 272  | 31 596   |  31 968 | 32 652  | 32 939 |   
#' |    Moyenne       | 21 876   | 22 212  | 22 524   |  22 824 | 23 328  | 23 553 |  
#'    
...
#'      
#' | Décile \ euros   | 2011     | 2013   | 2016    |  2018  |  
#' |------------------|----------|--------|---------|--------|   
#' |    D1            | 17 496   | 18 012 | 17 928  | 18 460 |  
#' |    D2            | 20 916   | 21 348 | 21 588  | 22 106 |   
#' |    D3            | 23 052   | 23 376 | 23 844  | 24 425 |  
#' |    D4            | 24 912   | 25 248 | 25 764  | 26 487 |  
#' |    D5 (médiane)  | 26 832   | 27 120 | 27 720  | 28 537 |   
#' |    D6            | 28 944   | 29 220 | 29 760  | 30 671 |   
#' |    D7            | 31 632   | 31 968 | 32 604  | 33 602 |   
#' |    D8            | 35 592   | 35 964 | 36 588  | 37 661 |   
#' |    D9            | 42 456   | 42 780 | 43 332  | 44 453 |   
#' | Moyenne          | 29 208   | 29 628 | 30 060  | 30 873 |  
#'   
...
#'    
#'     
#' | Décile \ euros   | 2011     | 2013   | 2016    | 2017  | 2018   |       
#' |------------------|----------|--------|---------|-------|--------|       
#' |    D1            | 16 584   | 17 016 |  17 460 | 17 688| 17 683 |   
#' |    D2            | 18 168   | 18 492 |  18 852 | 19 104| 19 131 |    
#' |    D3            | 19 620   | 19 872 |  20 160 | 20 460| 20 516 |  
#' |    D4            | 21 048   | 21 192 |  21 456 | 21 816| 21 917 |  
#' |    D5 (médiane)  | 22 596   | 22 656 |  22 848 | 23 220| 23 358 |    
#' |    D6            | 24 504   | 24 516 |  24 540 | 24 888| 25 041 |     
#' |    D7            | 27 216   | 27 252 |  27 108 | 27 408| 27 594 |     
#' |    D8            | 30 996   | 31 176 |  31 092 | 31 404| 31 564 |  
#' |    D9            | 37 812   | 38 100 |  38 064 | 38 388| 38 907 |    
#' |  Moyenne         | 26 496   | 26 916 |  27 096 | 27 456| 27 694 |  
#'    
...
#'*FPT categorie A*    
#'            
#' | Décile \ euros   | 2011     | 2013   |   2014   |  2016   |  2018  |  
#' |------------------|----------|--------|----------|---------|------- |    
#' |    D1            | 26 040   | 26 340 |  26 460  |  26 724 | 28 080 |    
#' |    D2            | 28 992   |        |          |         |        |   
#' |    D3            | 31 272   |        |          |         |        |   
#' |    D4            | 33 468   |        |          |         |        |   
#' |    D5 (médiane)  | 35 820   | 36 312 |  36 580  |  37 020 | 38 280 |  
#' |    D6            | 38 664   |        |          |         |        |   
#' |    D7            | 42 276   |        |          |         |        |   
#' |    D8            | 47 124   |        |          |         |        |   
#' |    D9            | 54 840   | 55 032 |  55 440  |  55 284 | 56 628 |       
#' |  Moyenne         | 38 700   | 39 120 |  39 360  |  39 564 | 40 920 | 
#'   
...
#' | Décile \ euros   | 2011     | 2013   |  2014   |  2016  |  2018  | 
#' |------------------|----------|--------|---------|--------|--------|   
#' |    D1            | 20 580   | 20 964 |  21 108 | 21 372 | 21 888 |
#' |    D2            | 22 272   |        |         |        |        |
#' |    D3            | 23 652   |        |         |        |        |
#' |    D4            | 24 960   |        |         |        |        | 
#' |    D5 (médiane)  | 26 244   | 26 820 |  27 000 | 27 216 | 27 768 |
#' |    D6            | 27 636   |        |         |        |        |
#' |    D7            | 29 160   |        |         |        |        |
#' |    D8            | 30 984   |        |         |        |        |
#' |    D9            | 33 804   | 34 224 | 34 344  | 34 560 | 35 304 |
#' |  Moyenne         | 26 940   | 27 408 | 27 588  | 27 828 | 28 428 |
#'  
...
#' | Décile \ euros   | 2011     | 2013   |  2014  |  2016  | 2018   |
#' |------------------|----------|--------|--------|--------|--------|
#' |    D1            | 15 972   |  16 296| 16 632 | 16 920 | 17 256 |
#' |    D2            | 16 896   |        |        |        |        |
#' |    D3            | 17 652   |        |        |        |        | 
#' |    D4            | 18 360   |        |        |        |        | 
#' |    D5 (médiane)  | 19 164   |  19 464| 19 884 | 20 256 | 20 868 |
#' |    D6            | 20 100   |        |        |        |        |
#' |    D7            | 21 216   |        |        |        |        |
#' |    D8            | 22 680   |        |        |        |        | 
#' |    D9            | 24 996   |  25 176| 25 608 | 26 028 | 26 844 |
#' |    Moyenne       | 20 016   |  20 268| 20 676 | 21 024 | 21 612 | 
#'    
...
#'### 4.3.3 Effet de noria et de variation d'effectifs sur rémunérations moyennes       
#'     
#'*Les calculs de RMPP sur la première année de la periode sous revue sont estimatifs et ne devraient pas être pris en compte pour publication.*      
#'   
#'      
...
#' 
#'| Annee      | 2009 | 2010 | 2011 | 2012 | 2013 | 2014 | 2015 | 2016  | 2017 |  2018 |
#'|:----------:|-----:|-----:|-----:|-----:|-----:|-----:|-----:|------:|-----:|-------|   
#'| SMPT brut  | 2,5  |  1,3 |  1,5 |  1,7 |  1,1 |  1,7 |  1,2 | 0,9   | 2,4  |  2,3  | 
#'| SMPT net   | 3,0  |  1,4 |  1,3 |  1,4 |  0,8 |  1,3 |  0,8 | 0,6   | 2,1  |  1,0  | 
#'| RMPP brute | 3,3  |  2,5 |  2,5 |  2,7 |  1,9 |  3,0 |  2,1 | 1,7   | 3,2  |  2,7  |
#'| RMPP nette | 3,3  |  2,5 |  2,3 |  2,4 |  1,6 |  2,7 |  1,7 | 1,3   | 2,8  |  1,5  |
#'    
...
#'    
#'|  Organisme   SMPT net     |  2013 | 2014  |  2015 | 2016 |  2017 | 2018 |   
#'|:-------------------------:|------:|------:|------:|-----:|------:|-----:|   
#'| Communes                  |  21 096  | 21 444 | 21 552 | 21 632| 22 116 |22 296 |   
#'| CCAS et caisses des écoles|  19 788  | 20 124 | 20 232 | 20 370| 20 796 |20 988 |    
#'| EPCI à fiscalité propre   |  23 184  | 23 412 | 23 424 | 23 754| 24 288 |24 528 |   
#'| Autres structures intercommunales |21 828 | 22 140| 22 332| 22 517| 22 908 |23 184 |   
#'|   Départements            | 24 852  | 25 068 | 25 344 | 25 391| 25 908 |26 124 |   
#'|   SDIS                    | 30 180  | 30 480 | 30 912 | 31 147| 31 740 |31 908 |   
#'|  Régions                  | 23 004  | 23 484 | 23 808 | 24 284| 24 936 |25 428 |   
#'| Autres collectivités locales| 24 828  | 25 032 | 25 368 | 25 456| 25 848 |25 932 |   
#'| Ensemble (moyenne)        | 22 212  | 22 524 | 22 692 | 22 819| 23 328 |23 556 |  
#'      
