...
#'  
#'      
conditionnel("Lien vers la base de données cumuls pfr/ifts", "Bases/Remunerations/beneficiaires.PFR.IFTS.csv")    
#'   
...
#'  
#'      
conditionnel("Lien vers la base de données cumuls pfr/iss", "Bases/Remunerations/beneficiaires.PFR.ISS.csv")    
#'   
...
#'  
#'      
conditionnel("Lien vers la base de données cumuls pfr/iemp", "Bases/Remunerations/beneficiaires.PFR.IEMP.csv")    
