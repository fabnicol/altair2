...
Tableau.data("organismes_smpt_net.csv", 
            c("Organisme SMPT net", 2014:2021))
...
Tableau.data("organismes_rmpp_net.csv",
            c("Organisme RMPP nette",  2014, "2014-2015", "2015-2016", "2016-2017", "2017-2018", "2018-2019", "2019-2020", "2020-2021"))
...
#'[Source RAEFP 2022 données 2020](Docs/RA_2022.pdf)   
#'[Source RAEFP 2023 données 2021](Docs/RA_2023.pdf)   
