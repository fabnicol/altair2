...
#'*(g) Postes actifs et non annexes :* voir [Compléments méthodologiques](Docs/methodologie.pdf)    
...
fichiers.pyr <- list.files(path= file.path(currentDir, "data"), pattern = "pyr_.*_.*.csv", full.names = TRUE)
