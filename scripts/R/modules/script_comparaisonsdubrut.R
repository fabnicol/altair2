...
#+ collapse = TRUE
#'   
#'*Salaires annnuels bruts moyens 2013-2021 en EQTP (hors assistantes maternelles)*
#'    
...
Tableau.vertical2(c("Agrégat (euros)", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021"),
...
Tableau.vertical2(
  c("Rém. annuelles",  "2020", "Primes", "2021", "Primes"),
  c("Salaire brut",
    "Traitement brut",
    "Primes et rémunérations annexes",
    "y compris IR et SFT"),
  digits = 0,
  12 * c(2584, 1943, 0, 641),
  c("", "24,8 %", "", "" ),
  12 * c(2612, 1976, 0, 636),
  c("", "24,3 %", "", "" ))
...
#'[2017](Docs/Vue3_Remuneration_2017.xlsx)    
#'[2018](Docs/Vue-Remunerations-2018.xlsx)   
#'[2019](Docs/Vue-Remunerations-2019.xlsx)    
#'[2020](Docs/Vue-Remunerations-2020.xlsx)    
#'[2021](Docs/Vue-Remunerations-2021.xlsx)    
#'[2022](Docs/remu_niveaux_2022.zip)    
#'[2023](Docs/remu_niveaux_2023.zip)    
...
#'[Source RAEFP 2022](Docs/RA_2022.pdf)   
#'[Source RAEFP 2023](Docs/RA_2023.pdf)   
#'[Synthèse 2023](Docs/RA_2023_vue_remunerations_niveaux.pdf)   
#'   
#'   
#'## 3.6 Coût chargé  
#'
