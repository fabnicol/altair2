...
#define BESOIN_MEMOIRE_ENTETE  19  /* nb d'éléments de l'enum ci-dessous */
...
typedef enum {Annee, Mois, Nom, Prenom, Matricule, NIR, NbEnfants, Statut, EmploiMetier, Grade, Indice,
...
static const char* entete_char[]={"R", "Année", "Mois", "Nom", "Prénom", "Matricule", "Service", "Nb.Enfants", "Statut", "Temps.de.travail",
                                  "Heures.Sup.", "Heures", "Indice", "Brut", "Net", "Net.à.Payer", "NBI", "Libellé", "Code",
                                  "Base", "Taux", "Nb.Unité", "Montant", "Type", "Emploi", "Grade", "Nir"};

static const char* entete_char_bulletins[]={"R", "Année", "Mois", "Nom", "Prénom", "Matricule", "Service", "Nb.Enfants", "Statut", "Temps.de.travail",
