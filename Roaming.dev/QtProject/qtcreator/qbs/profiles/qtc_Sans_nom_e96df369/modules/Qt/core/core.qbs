...
Module {
    ...
    property stringList staticLibsDebug: ["ole32", "uuid", "ws2_32", "advapi32", "shell32", "user32", "kernel32", "mpr", "qtpcred"]
    property stringList staticLibsRelease: ["ole32", "uuid", "ws2_32", "advapi32", "shell32", "user32", "kernel32", "mpr", "qtpcre"]
    ...
    property string libFilePathDebug: "C:/msys64/mingw64/qt5-static/lib/libQt5Cored.a"
    property string libFilePathRelease: "C:/msys64/mingw64/qt5-static/lib/libQt5Core.a"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["C:/msys64/mingw64/qt5-static/lib", "C:/msys64/mingw64/qt5-static/lib"]
    ...
    cpp.includePaths: {
        var paths = ["C:/msys64/mingw64/qt5-static/include", "C:/msys64/mingw64/qt5-static/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["C:/msys64/mingw64/qt5-static/lib/libqtmaind.a"] : ["C:/msys64/mingw64/qt5-static/lib/libqtmain.a"]);
        }
