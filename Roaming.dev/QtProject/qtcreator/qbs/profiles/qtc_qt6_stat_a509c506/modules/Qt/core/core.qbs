...
Module {
    ...
    cpp.includePaths: {
        var paths = ["C:/Users/Public/Dev/qt-5.6/qtbase/include", "C:/Users/Public/Dev/qt-5.6/qtbase/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["C:/Users/Public/Dev/qt-5.6/qtbase/lib/libqtmaind.a"] : ["C:/Users/Public/Dev/qt-5.6/qtbase/lib/libqtmain.a"]);
        }
